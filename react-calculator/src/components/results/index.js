  ...
  render(){
    ...
    return (
      ...
      {/* <div
        ...
        style={{backgroundColor:credit.bgColor}}
      >
      ...
      >
        {/* <div className="mortgage-result__logo">
          <img src="https://api.capitalgroup.ru/storage/images/76909ac44ee3e235c58927d1d63f11b0.png" alt="ДОМ.РФ">
        </div> */}
        {(credit.img && imageState) && (
          <div className="mortgage-result__logo">
            {/* <img src={credit.img} alt={credit.title} onError={this.handleImageError}/> */}
            <img src={credit.white_image} alt={credit.title} onError={this.handleImageError}/>
          </div>
        )}
        <div className="mortgage-result__text">
          <div className="mortgage-result__title">Ипотека</div>
          <div className="mortgage-result__subtext">ставка от {credit.percent}%{credit.stateSupport ? <span className={"disclaim-star"}>*</span> : ''}</div>
          <div className="mortgage-result__subtext">первый взнос от {credit.minFirstFeePercent}%</div>
          <div className="mortgage-result__subtext">срок кредита до {formatYears(credit.creditLength.max)}</div>
          <div className="mortgage-result__subtext">ежемесячный платеж - {formatMoney(true).to(credit.payPerMonth)}</div>
        </div>
      </div>
