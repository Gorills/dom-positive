    ...
    this.getDataFromServer(apiUrl, data => {
      ...
      data.data.forEach((credit, i) => {
        ...
        credits.push({
          ...
          bgColor: credit.bank.background_color,
          img: credit.bank.image,
          white_image: credit.bank.white_image,
    ...
    return (
      <div className="app" ref="app">
        ...
        <div className="center-wrapper">
          ...
          {/* <div className="disclaim">
            <p><span className={'disclaim-star'}>*</span> В рамках программы «Ипотека с господдержкой 2020» ставка в размере 4,3% действует в течение 6 месяцев, ставка 5,3% действует в течение  12 месяцев с даты заключения кредитного договора в случае оформления полного комплексного страхования и первоначальном взносе не менее 15%.</p>
            <p> По окончанию указанного периода ставка составит 6,5% при оформлении комплексного страхования.  Заемщики - граждане РФ. Программа распространяется на покупку строящегося жилья у юридического лица (за исключением инвестиционного фонда, в том числе его управляющей компании) и готового жилья по договору купли-продажи у застройщика. Сумма кредита для Москвы, Московской области, Санкт-Петербурга и Ленинградской области - не более 12 млн. руб., для остальных регионов – не более 6 млн. руб. Валюта кредита – рубли. Срок кредита – от 1 до 30 лет. Срок заключения кредитного договора до 01.07.2021 (включительно). </p>
