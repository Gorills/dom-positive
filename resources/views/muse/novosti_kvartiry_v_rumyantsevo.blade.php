...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.musepolyfill.bgsize.js", "require.js", "jquery.museresponsive.js", "novosti_kvartiry_v_rumyantsevo.css"], "outOfDate":[]};
</script>
  ...
  <link rel="stylesheet" type="text/css" href="css/novosti_kvartiry_v_rumyantsevo.css?crc=174435524" id="pagesheet"/>
  <link rel="stylesheet" type="text/css" href="css/header.css">
  <!-- IE-only CSS -->
  <!--[if lt IE 9]>
  <link rel="stylesheet" type="text/css" href="css/nomq_preview_master_top.css?crc=4022659591"/>
  <link rel="stylesheet" type="text/css" href="css/nomq_novosti_kvartiry_v_rumyantsevo.css?crc=4098673610" id="nomq_pagesheet"/>
  <![endif]-->
    <!--custom head HTML-->

<style>

#u55380 { height: 100%; min-height: 400px; position: fixed; }
.news_block a { text-decoration: none; color: #333337; border: none; }
.news_block a:hover { color: #999; }

.news_block {z-index: 4;
    width: 525px;
    min-height: 66px;
 ...
 <header class="header">
  ...
  <div class="breakpoint active" id="bp_infinity" data-min-width="1176"><!-- responsive breakpoint node -->
   <div class="clearfix borderbox" id="page"><!-- group -->
    ...
    <div class="size_fixed grpelem shared_content" id="u313867" data-sizePolicy="fixed" data-pintopage="page_fluidx" data-content-guid="u313867_content"><!-- custom html -->

            <div></div>

    </div>
    <div class="clearfix grpelem shared_content" id="pu676172" data-content-guid="pu676172_content"><!-- column -->
     <div class="size_fixed colelem" id="u676172" data-sizePolicy="fixed" data-pintopage="page_fluidx"><!-- custom html -->

		<div></div>

     </div>
     <div class="size_fixed colelem" id="u305828" data-sizePolicy="fixed" data-pintopage="page_fluidx"><!-- custom html -->

		<div></div>

     </div>
    </div>
    <div class="museBGSize grpelem shared_content" id="u55380" data-sizePolicy="fluidWidth" data-pintopage="page_fixedLeft" data-content-guid="u55380_content"><!-- simple frame --></div>
    ...
    <div class="clearfix grpelem" id="pu81112"><!-- column -->
     <div class="size_fixed colelem shared_content" id="u81112" data-sizePolicy="fixed" data-pintopage="page_fluidx" data-content-guid="u81112_content"><!-- custom html -->

            <div></div>

     </div>
     <!-- m_editable region-id="editable-static-tag-U56110-BP_infinity" template="novosti_kvartiry_v_rumyantsevo.html" data-type="html" data-ice-options="disableImageResize,link,txtStyleTarget" -->
     <div class="clearfix colelem shared_content" id="u56110-4" data-muse-uid="U56110" data-muse-type="txt_frame" data-IBE-flags="txtStyleSrc" data-sizePolicy="fixed" data-pintopage="page_fluidx" data-content-guid="u56110-4_content"><!-- content -->
      <h1>новости о ЖК Позитив</h1>
     </div>
     <!-- /m_editable -->
     <div class="colelem shared_content" id="u66421" data-content-guid="u66421_content"><!-- custom html -->
      @foreach($news as $item)
     </div>
     <!-- m_editable region-id="editable-static-tag-U66409-BP_infinity" template="novosti_kvartiry_v_rumyantsevo.html" data-type="html" data-ice-options="disableImageResize,link,txtStyleTarget" -->
     <div class="clearfix colelem shared_content" id="u66409-4" data-muse-uid="U66409" data-muse-type="txt_frame" data-IBE-flags="txtStyleSrc" data-sizePolicy="fixed" data-pintopage="page_fluidx" data-content-guid="u66409-4_content"><!-- content -->
      <p>{{ $item['published_at'] }}</p>
     </div>
     <!-- /m_editable -->
     <!-- m_editable region-id="editable-static-tag-U66410-BP_infinity" template="novosti_kvartiry_v_rumyantsevo.html" data-type="html" data-ice-options="disableImageResize,link,txtStyleTarget" -->
     <div class="novosti clearfix colelem shared_content" id="u66410-4" data-muse-uid="U66410" data-muse-type="txt_frame" data-IBE-flags="txtStyleSrc" data-sizePolicy="fixed" data-pintopage="page_fluidx" data-content-guid="u66410-4_content"><!-- content -->
      <h1>{!! $item['news_title'] !!}</h1>
     </div>
     <!-- /m_editable -->
     <div class="colelem shared_content" id="u66403" data-sizePolicy="fixed" data-pintopage="page_fluidx" data-content-guid="u66403_content"><!-- simple frame --></div>
     <div class="colelem shared_content" id="u211850" data-content-guid="u211850_content"><!-- custom html -->
      @endforeach
     </div>
    </div>
  ...
  <div class="breakpoint" id="bp_1175" data-max-width="1175"><!-- responsive breakpoint node -->
   <div class="clearfix borderbox temp_no_id" data-orig-id="page"><!-- group -->
    ...
    <span class="size_fixed grpelem placeholder" data-placeholder-for="u313867_content"><!-- placeholder node --></span>
    <span class="clearfix grpelem placeholder" data-placeholder-for="pu676172_content"><!-- placeholder node --></span>
    <span class="browser_width placeholder" data-placeholder-for="u178650-bw_content"><!-- placeholder node --></span>
    <span class="museBGSize grpelem placeholder" data-placeholder-for="u55380_content"><!-- placeholder node --></span>
    ...
    <div class="clearfix grpelem" id="pu81102"><!-- column -->
     <span class="size_fixed colelem placeholder" data-placeholder-for="u81102_content"><!-- placeholder node --></span>
     <!-- m_editable region-id="editable-static-tag-U56110-BP_1175" template="novosti_kvartiry_v_rumyantsevo.html" data-type="html" data-ice-options="disableImageResize,link,txtStyleTarget" -->
     <span class="clearfix colelem placeholder" data-placeholder-for="u56110-4_content"><!-- placeholder node --></span>
     <!-- /m_editable -->
     <span class="colelem placeholder" data-placeholder-for="u66421_content"><!-- placeholder node --></span>
     <!-- m_editable region-id="editable-static-tag-U66409-BP_1175" template="novosti_kvartiry_v_rumyantsevo.html" data-type="html" data-ice-options="disableImageResize,link,txtStyleTarget" -->
     <span class="clearfix colelem placeholder" data-placeholder-for="u66409-4_content"><!-- placeholder node --></span>
     <!-- /m_editable -->
     <!-- m_editable region-id="editable-static-tag-U66410-BP_1175" template="novosti_kvartiry_v_rumyantsevo.html" data-type="html" data-ice-options="disableImageResize,link,txtStyleTarget" -->
     <span class="novosti clearfix colelem placeholder" data-placeholder-for="u66410-4_content"><!-- placeholder node --></span>
     <!-- /m_editable -->
     <span class="colelem placeholder" data-placeholder-for="u66403_content"><!-- placeholder node --></span>
     <span class="colelem placeholder" data-placeholder-for="u211850_content"><!-- placeholder node --></span>
    </div>
    ...
    <div class="clearfix grpelem temp_no_id" data-orig-id="pu81059-4"><!-- group -->
     ...
     <span class="nonblock nontext MuseLinkActive menu-novosti clearfix placeholder" data-placeholder-for="u81063-4_content"><!-- placeholder node --></span>
    </div>
    <span class="size_fixed grpelem placeholder" data-placeholder-for="u81122_content"><!-- placeholder node --></span>
    <div class="clearfix grpelem" id="pu81039-4"><!-- group -->
     ...
     <span class="placeholder" data-placeholder-for="u513705_content"><!-- placeholder node --></span>
    </div>
