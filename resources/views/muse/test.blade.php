...
<header class="header">
    ...
    @php
        $menu = [
            [
                'title' => 'О проекте',
                'url'   => '/o_proekte_gk_pozitiv.html',
                'color' => 1
            ],
            [
                'title' => 'Как купить',
                'url'   => '/kak_kupit_kvartiru.html',
                'color' => 3
            ],
            [
                'title' => 'Ипотека',
            ...
            [
                'title' => 'Документы',
                'url'   => '/proektnaya_deklara%d1%81ia.html',
                'color' => 5
            ],
            [
                'title' => 'Галерея',
                'url'   => '/gallereya_dom_pozitiv.html',
                'color' => 6
            ],
            [
                'title' => 'Новости',
                'url'   => '/novosti_kvartiry_v_rumyantsevo.html',
                'color' => 7
            ],
            [
                'title' => 'Контакты',
    ...
    <nav class="menu">
        @foreach( $menu as $item )
            <a class="menu__item menu__item--color-{{$item['color']}} {{ isset($item['active'])  ? 'menu__item--active' : '' }}" href={{$item['url']}}>{{$item['title']}}</a>
        @endforeach
    </nav>

    <div class="phone-header">
        <a class="phone-header__tel" href="tel:+7 (495) 771-72-20" title="Позвонить">+7 (495) 771-72-20</a>
        <a class="phone-header__callback" href="#ck_callback_button">заказать звонок</a>
    </div>
